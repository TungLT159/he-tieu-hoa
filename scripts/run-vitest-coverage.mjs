...
const coverageRunRoot = resolve(os.tmpdir(), 'starter-tauri-app-vitest-coverage-runs')
...
const command = isJsExecpath ? process.execPath : pnpmCommand
const useShell = process.platform === 'win32' && command === pnpmCommand
